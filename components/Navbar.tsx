...
function Drawer ({ open }: { open: boolean }) {
  return (
    <div className={clsx(
      ...
      />
      <div className="flex text-2xl fixed inset-0 flex-col p-10 justify-center items-center space-y-6 font-bold sm:relative sm:text-sm sm:font-normal sm:justify-start sm:items-center sm:flex-row sm:space-y-0 sm:space-x-4 sm:p-0">
        {

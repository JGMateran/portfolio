		...
		<div className="md:flex md:items-center bg-slate-100 dark:bg-gray-800 border border-dotted border-slate-400 dark:border-gray-600 rounded-lg mb-8">
			...
			<div className="p-6 md:w-1/2">
				<div className="flex items-center mb-2">
					...
					<a
						aria-label="Go to the project on GitHub"
						href={github}
						className="ml-4"
						rel="noopener noreferrer"
						target="_blank"
...
const projects: ProjectTypes[] = [
	{
		...
		description:
			'A movie search engine where you can get information about current movies, actors information, see the trailer an much more.',
		image: '/images/01.png',
	...
	},
	{
		...
		description:
			'A tool to easily create modern and beautiful twitter cards to post on social network.',
		image: '/images/02.png',
		url: 'https://beautiful-twitter-cards.vercel.app/',
		github: 'https://github.com/JGMateran/beautiful-twitter-cards',
		technologies: ['Vite', 'TailwindCSS'],
	},
	{
		id: 2,

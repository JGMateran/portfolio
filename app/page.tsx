...
const description = 'I am a front-end web developer specialized in the React and TypeScript ecosystem with more than 5 years of experience building digital products.'
...
export default function HomeRoute () {
  return (
    <>
      <div className="selection:bg-blue-600 selection:text-white py-16 bg-slate-200 dark:bg-gray-800 text-black dark:text-white leading-7">
